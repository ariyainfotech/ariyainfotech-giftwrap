<?php
namespace AriyaInfoTech\GiftWrap\Model\Plugin\Quote;
...
class QuoteToOrderItem
{
  ...
  public function aroundConvert(
        ...
        $orderItem->setIsGiftWrap($item->getIsGiftWrap());//set your required
		$orderItem->setGiftWrapMessage($item->getGiftWrapMessage());//set your required
